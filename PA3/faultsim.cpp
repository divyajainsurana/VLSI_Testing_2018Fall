...
//simulate V1 and check activated faults
 ...
 start_wire_index = 10000;
 // V2 for every input, set its value to the current vector value 
  for(i = 0; i < cktin.size(); i++) {
...
if (f->activate == TRUE && f->fault_type!= sort_wlist[f->to_swlist]->value) {
